...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_pronunciation_dictionary_id,
            commands::create_amin_pronunciation_dictionary,
            commands::add_pronunciation_rule,
            ...
            commands::start_speaker_enrollment,
            commands::has_enrolled_speaker,
            commands::clear_enrolled_speaker,
